...
function start() {
	...
	return (
		<div className="flex flex-col min-h-screen bg-green-500">
			...
			<btn className="w-1/8 bg-purple-500 hover:bg-green-900 text-white font-bold py-2 px-4 border-b-4 border-purple-700 hover:border-green-800 rounded" onClick={() => router.push('../quizcomp/QuizMain')}>Start Post Quiz</btn>
