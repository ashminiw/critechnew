	...
	return (
		<div className="flex flex-col min-h-screen bg-green-500">
			...
			<div className="bg-purple-400 py-16 flex items-center justify-center space-x-8">
				<p>Data Privacy</p>
				<div className="bg-green-300 w-24 h-24 rounded-full"></div>
				<div className="bg-green-400 w-24 h-24 rounded-full"></div>
				<div className="bg-green-500 w-24 h-24 rounded-full"></div>
				<div className="bg-green-600 w-24 h-24 rounded-full"></div>
				<div className="bg-green-700 w-24 h-24 rounded-full"></div>
			</div>
			</div>
			<div className="grid grid-cols-1">
			<div className="bg-yellow-400 py-16 flex items-center justify-center space-x-8">
				<p>Fake News</p>
			<div className="bg-blue-300 w-24 h-24 rounded-full"></div>
				<div className="bg-blue-400 w-24 h-24 rounded-full"></div>
				<div className="bg-blue-500 w-24 h-24 rounded-full"></div>
				<div className="bg-blue-600 w-24 h-24 rounded-full"></div>
				<div className="bg-blue-700 w-24 h-24 rounded-full"></div>
			</div>
			</div>
			<div><Footer/></div>
