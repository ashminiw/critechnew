...
export default () => {
  ...
  return(
    ...
    <Head><title> Critech </title></Head>
      ...
      <text className="text-5xl text-purple-700 text-center">Changing the world</text>
      <text>One student at a time</text>
      <br></br>
      <p>
        <Link href="/login">
          <a className="text-2xl text-center bg-purple-300 w-64 text-white py-1 rounded font-medium">Login</a>
        </Link>
      </p>
      </div>
      <Footer/>
