	...
	return (
		<div className="flex flex-col min-h-screen bg-green-500">
			...
			<div className="bg-green-400 py-16 flex items-center justify-center space-x-8">
				<p>Cyberbullying</p>
				<div className="bg-red-400 w-24 h-24 rounded-full flex items-center justify-center text-center" onClick={() => router.push('./modules/quiz1/cyberbullying/start')}>Module1</div>
