...
function cridgets() {
	...
	return (
		<div className="flex flex-col min-h-screen bg-green-500">
			...
			<div className="bg-purple-50 w-32 h-32 p-4 rounded-full flex items-center justify-center text-center" onClick={() => router.push('./modules/quiz1/Please')}> Cyberbullying </div>
			</div>
