...
export default () => {
  ...
  return(
    ...
    <Head><title> Critech </title></Head>
      ...
      <p>
        <Link href="/login">
          <button className="bg-transparent hover:bg-purple-500 text-purple-700 font-semibold hover:text-white py-2 px-4 border border-purple-500 hover:border-transparent rounded">Get Started</button>
        </Link>
      </p>
      </div>
      <Footer/>
