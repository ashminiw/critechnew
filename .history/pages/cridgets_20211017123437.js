...
function cridgets() {
	...
	return (
		<div className="flex flex-col min-h-screen bg-green-500">
			...
			<div className="bg-purple-50 w-32 h-32 p-4 rounded-full flex items-center justify-center text-center"> <Image className="rounded-full" src="/chris.png" width={256} height={77} /> </div>
